...
myParcelAnalysis = parcelAnalysis(
    pressure,
    temperature,
    dewPointTemperature,
    hPa=True,
...
mySkewT_Axes.plot(
    myParcelAnalysis["temperatureAtLCL"],
    myParcelAnalysis["pressureAtLCL"],
    marker="o",
    color="b",
    label="LCL",
...
mySkewT_Axes.plot(
    myParcelAnalysis["temperatureAtLFC"],
...
dewPointTemperature = 243.5 / (
    (17.67 / numpy.log(vaporPressure * 0.01 / 6.112)) - 1.0
)  # In celsius
...
myColorPlot = myBaseMap.pcolormesh(
    lon, lat, myParcelAnalysis["CAPE"][0, :], latlon=True, cmap="jet"
)
